...
{	// Bandera de que se esta subiendo a la posicion final 
	...
	{	// Cuando el secado lleva 1250ms subiendo hacia la posicion final se paran los motors 
		if(milisecondsFinal_SH + 1250 < miliseconds)	// y se baja la bandera SH_up_final
		{
			M5_state = OFF;
			SH_up_final = 0;
			SH = 0;
