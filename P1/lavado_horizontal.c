...
{	   
    if(LH==1){																			//Bandera que indica si el lavado horizontal esta activo
        if(((PINK_prev&0x20)==0x00)&&((PINK&0x20)==0x20)&&((PINK&0x1C)==0x1C)){ 		//Se comprueba si ha habido flaNco de subida en S06 y si S03,S04 y S05 no detectan nada, el coche esta saliendo
            LH=0;
            ...
            if((PINK&0X14)==0X14){														//Se comprueba si S03 y S05 estan detectando algo
                if((PINK&0X08)==0X00){													//Se comprueba si S04 esta detectando algo
